...
const STRINGS = {
  en: {
    ...
    showMore:'Show {n} more', showFewer:'Show fewer',
  ...
  tr: {
    ...
    showMore:'{n} tane daha göster', showFewer:'Daha az göster',
    meetsDuty:'Q={q} değerinde {head} m · görevin {over} üzerinde',
    stagesLbl:'Kademe', impeller:'Çark çapı', casing:'Gövde', dnLbl:'Çıkış',
  ...
  ar: {
    ...
    showMore:'عرض {n} إضافية', showFewer:'عرض أقل',
  ...
  es: {
    ...
    showMore:'Mostrar {n} más', showFewer:'Mostrar menos',
